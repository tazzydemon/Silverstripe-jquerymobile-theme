					...
					<% if ShowInCart %>
						<li id="$CartID" class="$Classes">
							<span class="itemdetails">
								...
								<span class="quantity">
									<div class="quantitylabel">Quantity :</div> $QuantityField
								</span>
								<span class="remove">
									<a class="ajaxQuantityLink" data-ajax="false" href="$removeallLink" title="<% sprintf(_t("REMOVEALL","Remove all of &quot;%s&quot; from your cart"),$CartTitle.XML) %>">
										<img src="/$ThemeDir(ecommerce)/images/remove.gif" alt="x"/> Empty Cart
									</a>
								</span>
							</span>
							<div class="clear"><!-- --></div>
