<h3 class="orderInfo"><% _t("ORDERINFORMATION","Order Information") %> Mob JQ Version</h3>
				...
				<% if ShowInTable %>
					<tr id="$TableID" class="$Classes">
						...
						<td class="right remove">
							<strong>
								<a class="ajaxQuantityLink" data-ajax="false" href="/$removeallLink" title="<% sprintf(_t("REMOVEALL","Remove all of &quot;%s&quot; from your cart"),$TableTitle) %>">
									<img src="/$ThemeDir(ecommerce)/images/remove.gif" alt="x"/>
								</a>
							</strong>
						</td>
					</tr>
